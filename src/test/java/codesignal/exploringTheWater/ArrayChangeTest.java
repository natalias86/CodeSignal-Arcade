...
public class ArrayChangeTest {
    ...
    public ArrayChange arrayChange;
    ...
    public void check() {
        ...
        Assert.assertEquals(arrayChange.arrayChange(inputArray), expectedResult);
    }
